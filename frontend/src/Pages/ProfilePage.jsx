...
const ProfilePage = () => {
  ...
  return (
    ...
    <div className='container mx-auto px-4 pt-20  max-w-5xl flex-grow p-5'>
        ...
        <div className='bg-base-300 rounded-xl p-6 space-y-8'>
         ...
         <div className='flex flex-col items-center  gap-4'>
          <div className='relative'>
            <img src={SelectedImg||authUser.profilePic||"https://cdn-icons-png.flaticon.com/512/6596/6596121.png"}
             alt='Profile'
...
<p className='px-4 py-2.5 bg-base-200 rounded-lg border'>{authUser?.email}</p>
         ...
         <div className='mt-9 bg-base-300 rounded-xl p-6'>
          <h2 className='text-lg font-medium mb-4'>Account Information</h2>
          <div className='space-y-3 text-sm'>
            <div className='flex items-center justify-between py-2 border-b border-zinc-700'>
              <span>Menber Since</span>
